            ...
            <div class="row purchace-popup">
              ...
              <span class="d-block d-md-flex align-items-center">
                ...
                <a class="btn ml-auto download-button d-none d-md-block"
                   href="https://github.com/BootstrapDash/StarAdmin-Free-Bootstrap-Admin-Template" target="_blank">Download Free Version</a>
                            ...
                            <div class="fluid-container">
                                ...
                                <div class="row ticket-card mt-3 pb-2 border-bottom pb-3 mb-3">
                                    ...
                                    <div class="ticket-details col-md-9">
                                        ...
                                        <p class="text-gray ellipsis mb-2">Pellentesque in ipsum id orci
                                        ...
                                        <div class="row text-gray d-md-flex d-none">
                                            ...
                                            <div class="col-4 d-flex">
                                                ...
                                                <small class="Last-responded mr-2 mb-0 text-muted">2 Days
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row ticket-card mt-3">
                                    ...
                                    <div class="ticket-details col-md-9">
                                        ...
                                        <p class="text-gray ellipsis mb-2">Nulla quis lorem ut libero
                                            malesuada feugiat. Proin eget tortor risus. Lorem ipsum dolor
                                            sit amet.</p>
                                        <div class="row text-gray d-md-flex d-none">
                                            <div class="col-4 d-flex">
                                                <small class="mb-0 mr-2 text-muted">Last responded :</small>
